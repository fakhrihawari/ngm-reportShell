...
4. Update the GitHub repository locations to your forked version of the code
		...
		[ngm-reporthub.shell.build.sh *line 156*] sudo git clone https://github.com/<your.fork>/ngm-reportHub.git
		[ngm-reporthub.shell.build.sh *line 190*] sudo git clone https://github.com/<your.fork>/ngm-reportEngine.git
